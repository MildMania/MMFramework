            ...
            (
                ...
                (
                    ...
                    (
                        ...
                        new PhaseGotoNode(huntPhase) // game is not ready to finish (ie. not all bugs are catched, not all objecives are completed etc)
                    )
                ),
                new PhaseSerialComposition // other mini game result
                (
                    new CatchFailPhase(), // char fails to catch, or gets away from bug
                    new PhaseGotoNode(huntPhase) // returns to hunt phase
                )
            )
        );
    }
